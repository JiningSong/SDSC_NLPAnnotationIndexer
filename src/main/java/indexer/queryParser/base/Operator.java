package indexer.queryParser.base;

import indexer.queryParser.util.MathUtil;

import static indexer.queryParser.base.Operator.Associativity.LEFT;
import static indexer.queryParser.base.Operator.Associativity.RIGHT;
