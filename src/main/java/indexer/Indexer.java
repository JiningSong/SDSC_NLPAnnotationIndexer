...
public class Indexer {
    ...
    public static void main(String[] args) throws ClassNotFoundException, IOException {
        ...
        PostingListItem testItem1 = new PostingListItem(testPair1);
        PostingListItem testItem2 = new PostingListItem(testPair2);
        PostingListItem testItem3 = new PostingListItem(testPair3);
        PostingListItem testItem4 = new PostingListItem(testPair4);
        PostingListItem testItem5 = new PostingListItem(testPair5);
        PostingListItem testItem6 = new PostingListItem(testPair6);

        // System.out.println(testTable);
        PostingList testList1 = new PostingList();
        testList1.appendItem(testItem1);
        testList1.appendItem(testItem2);
        testList1.appendItem(testItem3);

        PostingList testList2 = new PostingList();
        testList2.appendItem(testItem4);
        testList2.appendItem(testItem5);
        testList2.appendItem(testItem6);
        ...
        System.out.println("-------intersection (and)-------");
        PostingList intersectionList = PostingList.intersection(testList1, testList2);
        System.out.println(intersectionList.toString());

        System.out.println("-------union (or)-------");
        PostingList unionList = PostingList.union(testList1, testList2);
